# -*- coding: utf-8 -*-
# Generated by Django 1.9.7 on 2016-07-07 11:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=30)),
                ('server_path', models.FileField(upload_to=app.models.get_resource_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.CharField(max_length=300)),
                ('server_path', models.FileField(default='/task', upload_to=app.models.get_task_file_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pic', models.CharField(default='none', max_length=50)),
            ],
        ),
        migrations.CreateModel(
            name='UserCourse',
        ...
        migrations.AddField(
            model_name='resource',
            name='resource_class',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.ResourceClass'),
        ),
        migrations.AddField(
            model_name='message',
            name='user',
